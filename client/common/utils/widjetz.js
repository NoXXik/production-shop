...
function ISDEKWidjet(params) {
    ...
    if (!params.path) {
        ...
        scriptPath = scriptPath.substring(0, scriptPath.indexOf('widjetz.js')) + 'scripts/';
    ...
    var HTML = {
        ...
        getBlock: function (block, values) {
            if (typeof HTML.blocks[block] != 'undefined') {
                let _tmpBlock = HTML.blocks[block];
                if (typeof values == 'object') {
                    for (const keyVal in values) {
    ...
    var LANG = {
        ...
        replaceAll: function (content) {
            for (const langKey in this.collection) {
    ...
    var template = {
        ...
        html: {
            ...
            loadCityList: function (data) {
                ...
                let _list = ipjq(IDS.get('city_list'));
                for (var i in data) {
                    let _block = HTML.getBlock('city', {
                        'CITYID': i,
                        'CITYNAME': data[i],
                    ...
                    for (var i in obPrices) {
                        ...
                        switch (i) {
                            ...
                            case 'pickup':
                                ...
                                let _tmpBlock = HTML.getBlock('d_' + i, {
        ...
        ymaps: {
            ...
            placeMarks: function (mtypes) {
                ...
                let _panelContent = ipjq(IDS.get('pointlist')).find('.CDEK-widget__panel-content');
                ...
                if (typeof pvzList === 'object') {
                    ...
                    for (var i in pvzList) {
                        ...
                        pvzList[i].placeMark.events.add(['balloonopen', 'click'], function (metka) {
                            let _prevMark = template.ui.currentmark;
                    ...
                    let _bounds = template.ymaps.clusterer.getBounds();
            ...
            makeUpCenter: function (cords) {
                ...
                let ww = ipjq(IDS.get('panel')).width();
            ...
            selectMark: function (wat) {
                ...
                if (typeof cityPvz[wat].Picture != 'undefined') {
                    for (const _imgIndex in cityPvz[wat].Picture) {
